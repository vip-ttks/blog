...
eval(function(h, b, i, d, g, f) {
    ...
    a.ias.defaults = {
        ...
        next: ".next",
        noneleft: !1,
        loader: '<img src="/wp-content/themes/yusi1/images/loader.gif"/>',
        loaderDelay: 600,
            ...
            case "comment-insert-smilie":
                if (!a("#comment-smilies").length) {
                    ...
                    for (key in g.smilies) {
                        x += '<img data-simle="' + key + '" data-type="comment-smilie" src="/wp-content/themes/yusi1//index.html' + _deel.url + "/img/smilies/icon_" + g.smilies[key] + '.gif">'
                    }
